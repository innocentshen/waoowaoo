...
export const PROMPT_CATALOG: Record<PromptId, PromptCatalogEntry> = {
  ...
  [PROMPT_IDS.NP_VIDEO_PROMPT_GENERATE]: {
    pathStem: 'novel-promotion/video_prompt_generate',
    variableKeys: [
      'prompt_mode',
      'full_story_text',
      'panel_story_text',
      ...
      'panel_location',
      'panel_props',
      'panel_dialogue_lines',
      'next_panel_story_text',
      'next_image_prompt_input',
      'next_panel_shot_type',
      'next_panel_camera_move',
      'next_panel_characters',
      'next_panel_location',
      'next_panel_props',
      'next_panel_dialogue_lines',
