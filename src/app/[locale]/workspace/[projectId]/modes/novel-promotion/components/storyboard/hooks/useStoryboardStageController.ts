...
export function useStoryboardStageController({
  ...
  return {
    localStoryboards, setLocalStoryboards, sortedStoryboards, expandedClips, toggleExpandedClip, panelEdits,
    getClipInfo, getTextPanels, getPanelEditData, updatePanelEdit, formatClipTitle, totalPanels, storyboardStartIndex,
    savingPanels, deletingPanelIds, movingPanelId, creatingPanelAfterId, creatingPanelStoryboardId, isCreatingPanel, saveStateByPanel, hasUnsavedByPanel, submittingStoryboardTextIds, addingStoryboardGroup, movingClipId, insertingAfterPanelId,
    savePanelWithData, addPanel, movePanel, deletePanel, deleteStoryboard, regenerateStoryboardText, addStoryboardGroup, moveStoryboardGroup, insertPanel,
    submittingVariantPanelId, generatePanelVariant,
    panelCandidateIndex, submittingStoryboardIds, submittingPanelImageIds, selectingCandidateIds,
    editingPanel, setEditingPanel, uploadingPanels, modifyingPanels, cancelablePanelImageTaskIds, cancelingPanelImageIds, isCancelingAllPanelImageTasks, isDownloadingImages, previewImage, setPreviewImage,
    regeneratePanelImage, uploadPanelImage, selectPanelSourceImage, selectPanelHistoryImage, regenerateAllPanelsIndividually, selectPanelCandidate, selectPanelCandidateIndex,
    cancelPanelCandidate, getPanelCandidates, modifyPanelImage, downloadAllImages, cancelPanelImageTask, cancelAllRunningPanelImageTasks, clearStoryboardError,
    assetPickerPanel, setAssetPickerPanel, sourcePanelPickerPanelId, setSourcePanelPickerPanelId, historyPanelPickerPanelId, setHistoryPanelPickerPanelId, aiDataPanel, setAIDataPanel, isEpisodeBatchSubmitting,
