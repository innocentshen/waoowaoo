...
export function useStoryboardStageController({
  ...
  return {
    ...
    editingPanel, setEditingPanel, uploadingPanels, modifyingPanels, isDownloadingImages, previewImage, setPreviewImage,
    regeneratePanelImage, uploadPanelImage, selectPanelSourceImage, regenerateAllPanelsIndividually, selectPanelCandidate, selectPanelCandidateIndex,
    cancelPanelCandidate, getPanelCandidates, modifyPanelImage, downloadAllImages, clearStoryboardError,
    assetPickerPanel, setAssetPickerPanel, sourcePanelPickerPanelId, setSourcePanelPickerPanelId, aiDataPanel, setAIDataPanel, isEpisodeBatchSubmitting,
